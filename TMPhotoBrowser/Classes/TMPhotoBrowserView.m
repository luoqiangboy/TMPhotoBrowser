...
@interface TMPhotoBrowserView() <UIScrollViewDelegate>
@property (nonatomic,strong) TMWaitingView *waitingView;
@property (nonatomic, strong) NSURL *imageUrl;
@property (nonatomic, strong) UIImage *placeHolderImage;
@property (nonatomic, strong) UIButton *reloadButton;
@end

@implementation TMPhotoBrowserView
//- (void)dealloc{
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    //添加进度指示器
    TMWaitingView *waitingView = [[TMWaitingView alloc] init];
//    waitingView.mode = TMWaitingViewModeLoopDiagram;
