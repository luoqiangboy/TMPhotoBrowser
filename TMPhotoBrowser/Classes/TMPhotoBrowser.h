...
- (NSURL *)photoBrowser:(TMPhotoBrowser *)browser highQualityImageURLForIndex:(NSInteger)index;
@end


@interface TMPhotoBrowser : UIView <UIScrollViewDelegate>
